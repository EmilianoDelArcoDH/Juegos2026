...
> {
  ...
  _initializeAuthenticatedUser() {
    ...
    this.setState(({ authenticatedUser }) => ({
      authenticatedUser: {
        ...
        onOpenLoginDialog: () => {}, // Deprecated - no longer functional
        onOpenLoginWithPurchaseClaimDialog: () => {}, // Deprecated - no longer functional
  ...
  _doCreateAccount = async (
    ...
    try {
      ...
      this.showUserSnackbar({
        message: username ? (
          <Trans>👋 Welcome to DigitalHouse {username}!</Trans>
        ) : (
          <Trans>👋 Welcome to DigitalHouse!</Trans>
        ),
      });
    } catch (apiCallError) {
      this.setState({
